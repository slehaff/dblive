...
def load_model():
    model = keras.models.load_model(
        '/home/samir/dblive/cnnpredict/models/UNmodels/UNet02-31-fringe-wrapdata'+'-100-adam-noBN.h5')
    model.summary()
    return(model)
...
model.save('/home/samir/dblive/cnnpredict/models/UNmodels/UNet02-400-fringe-wrapdata'+'-200-adam-noBN.h5', save_format='h5')
