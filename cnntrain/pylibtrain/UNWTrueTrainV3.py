...
def load_model():
    model = tf.keras.models.load_model(
        '/home/samir/dblive/cnnpredict/models/UN15models/UN15may-UNWK-dmix-b8-30.h5')
    model.summary()
    return(model)
...
model.save('/home/samir/dblive/cnnpredict/models/UN15models/UN15may-UNWK-dmix-b8-60.h5', save_format='h5')
cv2.imwrite('validate/'+'UN15may-UNWK-dmix-b8-60.png',
