...
def nnLprocess(folder):
    ...
    cv2.imwrite( folder + 'nnkdata.png',255*nnkdata)
...
folder = '/home/samir/Desktop/blender/pycode/30train800TF/render'
bfolder = '/home/samir/Desktop/blender/pycode/30train800TF/'
