...
to_png_array('/home/samir/Desktop/blender/pycode/160planes/render', 'blenderimage0', input_images, IMAGECOUNT)
...
myfile = '/home/samir/Desktop/blender/pycode/160planes/render' + str(1)+'/blenderimage0.png'
img = cv2.imread(myfile).astype(np.float32)
img = normalize_image255(img)
inp_img = make_grayscale(img)
...
for i in range(0, 20, 1):
    ...
    myfile = '/home/samir/Desktop/blender/pycode/160planes/render' + str(i)+'/blenderimage0.png'
    img = cv2.imread(myfile).astype(np.float32)
    img = normalize_image255(img)
    inp_img = make_grayscale(img)
    #get_my_file('out/' + str(i)+'.png')
    myfile = '/home/samir/Desktop/blender/pycode/160planes/render' + str(i)+'/im_wrap1.png'
    img = cv2.imread(myfile).astype(np.float32)
    img = normalize_image255(img)
